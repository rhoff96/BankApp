...
public class JdbcTransactionDaoTests extends BaseDaoTests {
    ...
    @Test
    public void when_valid_customer_id_then_get_transactions_by_customer_id(){
        ...
        Assert.assertEquals("Customer id should return correct size list",2,retrieved.size());
        Assert.assertEquals("Lists should be equal",TRANSACTION_3,retrieved.get(0));
        Assert.assertEquals("Lists should be equal",TRANSACTION_2,retrieved.get(1));
    }
}
